...
export const AlertPageElement = {
  type: 'alertpage',
  label: 'Alert',
};

export function AlertPageContent() {
  ...
  return (
    <div className="w-full h-full p-9 flex flex-col gap-9">
      ...
      <div className="w-[850px] h-[150px] bg-gradient-to-b from-[#dddddd] to-[#747474] text-white p-5 rounded-lg flex flex-col gap-2">
        <h1 className="text-3xl font-notosans font-bold text-slate-900 ">Alert</h1>
        <p className="font-notosans text-slate-800 font-medium">Displays a alert or a component that looks like a alert</p>
      ...
      <div className="flex flex-col gap-5 w-[50%]">
         ...
         <div className="w-full h-[250px] flex flex-col gap-3 mt-5">
           <lable className='font-notosans text-xl font-semibold'>Simple Alert</lable>
